...
export function JsonToTypescriptConverter() {
  ...
  return (
    <div className="grid gap-6 lg:grid-cols-2">
      <div>
        <label htmlFor="json-to-typescript-input" className="mb-2 block text-sm font-medium text-zinc-700">
          JSON input
        </label>
        <textarea
      ...
      <div>
        <label htmlFor="json-to-typescript-output" className="mb-2 block text-sm font-medium text-zinc-700">
          TypeScript output
        </label>
        <textarea
          id="json-to-typescript-output"
          value={output}
          readOnly
          spellCheck={false}
