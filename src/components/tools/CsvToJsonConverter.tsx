...
export function CsvToJsonConverter() {
  ...
  return (
    <div className="grid gap-6 lg:grid-cols-2">
      <div>
        <label htmlFor="csv-to-json-input" className="mb-2 block text-sm font-medium text-zinc-700">
          CSV input
        </label>
        <textarea
      ...
      <div>
        <label htmlFor="csv-to-json-output" className="mb-2 block text-sm font-medium text-zinc-700">
          JSON output
        </label>
        <textarea
